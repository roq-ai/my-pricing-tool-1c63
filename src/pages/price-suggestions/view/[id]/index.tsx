...
import { getPriceSuggestionById } from 'apiSdk/price-suggestions';
...
function PriceSuggestionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Price Suggestion Detail View
          </Text>
          {hasAccess('price_suggestion', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/price-suggestions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
